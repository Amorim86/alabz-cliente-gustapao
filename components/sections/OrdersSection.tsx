    ...
    <section id="encomendas" className="relative w-full overflow-hidden">
      <div className="flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-1/2 bg-wine-dark flex items-center">
          <div className="w-full px-8 md:px-16 py-16 md:py-24 max-w-xl mx-auto md:mx-0 md:ml-auto">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-cream mb-6 leading-tight">
              O famoso Pão com Bolinho e lanches irresistíveis
            </h2>

            <p className="text-white/75 text-base mb-4 leading-relaxed">
              De misto quente caprichado a lanches com ovos, a nossa cozinha prepara clássicos de chapa na hora. E você não pode deixar de provar o nosso tradicional Pão com Bolinho, um dos preferidos dos clientes.
            </p>

            <p className="text-white/60 text-sm mb-10 leading-relaxed">
              Conte com a Gustapão para o seu café da manhã, lanche da tarde ou pós-plantão. Todos os nossos produtos são preparados frescos diariamente, prontos para consumo no local ou para você levar para casa.
            </p>
        ...
        <div className="w-full md:w-1/2 min-h-[400px] md:min-h-[600px] relative bg-[#c8bfb0]">
          <SafeImage
            src="/pao com bolinho premium.webp"
            alt="Pão com Bolinho delicioso da Panificadora Gustapão"
